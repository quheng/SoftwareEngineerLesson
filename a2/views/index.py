...
def orderdetails():
    ID = request.cookies.get('kitty')
    # if ID:
    return render_template("a2/orderdetails.html", userID = 0)
    # else:
        # return redirect("http://121.42.175.1/login")
...
def complaint():
    ID = request.cookies.get('kitty')
    # if ID:
    return render_template("a2/complaint.html", userID = 0)
    # else:
        # return redirect("http://121.42.175.1/login")
...
def orderlist():
    ID = request.cookies.get('kitty')
    # if ID:
    return render_template("a2/orderlist.html", userID = 0)
    # else:
        # return redirect("http://121.42.175.1/login")